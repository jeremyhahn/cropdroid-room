...
const char * const string_table[] PROGMEM = {
  ...
  string_json_key_co2,
  string_json_key_leak0,
  string_json_key_leak1,
...
int idx_initializing = 0,
	...
	idx_json_key_vpd = 23,
	idx_json_key_water0 = 24,
	idx_json_key_water1 = 25,
	idx_json_key_co2 = 26,
	idx_json_key_leak0 = 27,
	idx_json_key_leak1 = 28,
	idx_json_key_photo = 29,
	idx_json_key_metrics = 30,
	idx_json_key_channels = 31,
	idx_json_key_channel = 32,
	idx_json_key_pin = 33,
	idx_json_key_position = 34,
	idx_json_key_value = 35,
	idx_json_key_address = 36,
	idx_json_key_bracket_open = 37,
	idx_json_key_bracket_close = 38,
	idx_json_error_invalid_channel = 39,
	idx_json_reboot_true = 40,
	idx_json_reset_true = 41,
	idx_hardware_version = 42,
	idx_firmware_version = 43,
	idx_json_key_uptime = 44;
...
float roomTempF0, roomTempC0, roomHumidity0, roomHeatIndex0,
      ...
      water0Temp, water1Temp, CO2PPM, VPD = 0.0;
...
void readPodTemps() {
  water0Temp = sensors.getTempFByIndex(0);
  water1Temp = sensors.getTempFByIndex(1);

#if DEBUG
  Serial.print("water0:");
  Serial.println(water0Temp);
  Serial.print("water1:");
  Serial.println(water1Temp);
#endif
}
...
void co2ppm() {
  ...
  int sensorValue = analogRead(ANALOG_CO2_PIN);
